...
reminders: 'reminder',
	...
	roomhelp: function (target, room, user) {
		...
		this.sendReplyBox(
		    ...
		    "- /closeleague <em>[#]</em>: close the league for block the challengers<br />" +
	        "- /leaguestatus <em>[+/%/@/#]</em>: show the league status close or open<br/>" +
		    "- /openleague <em>[#]</em>: open the league for the challengers<br />" +
		"</div>"
		);
	},
